...
public class SystemCommandExecutor {
    ...
    public boolean executeCommand(String commandLineInput)
        ...
        try {
            ...
            // added by Abdullah Haidar
            // TODO perhaps a better way to give input to the process
            PrintWriter writer = new PrintWriter(stdOutput);
            writer.println(commandLineInput);
            writer.flush();
            writer.close();
            ...
            return errorStreamHandler.getOutputBuffer().length() == 0;
        }
    }
