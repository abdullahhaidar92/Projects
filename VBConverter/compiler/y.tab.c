...
static const short yyrline[] = { 0,
    29,    32,    33,    36,    37,    40,    68,   101,   125,   126,
   130,   139,   142,   149,   160,   164,   168,   171,   175,   179,
   183,   186,   190,   191,   194,   197,   201,   204,   208,   211,
   214,   217,   221,   224,   230,   231,   232,   233,   234,   237,
   238,   241,   242,   245,   246,   247,   248,   251,   252,   253,
   254,   256,   257,   260,   261,   264,   265,   266,   267,   270,
   271
};
...
{ 
                                             ...
                                             while(variable){
                                                ...
                                                strdup(variable),strdup(yyvsp[-3].stringValue),strdup(value));
                                                variable=pop(&variablesWithValuesStack);
                                                value=pop(&variablesValuesStack);
                                                flag=1;
                                             }
