...
|OpenIfStatement {$<strVal>$=strdup($<strVal>1);}
;
...
IfStatement :If LP LogicExpression RP Statement Else Statement {
...
Comparator: ArithmaticExpression Operation ArithmaticExpression { str=concat($<strVal>1,$<strVal>2);
                                                                  $<strVal>$=concat(str,$<strVal>3);
                                                                 }
;
...
Assignment: Id '=' ArithmaticExpression  {    str=concat($<strVal>1,strdup(" = "));
                                              $<strVal>$=concat(str,strdup($<strVal>3));
                                         }
;
